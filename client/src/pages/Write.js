    ...
    <div className="add">
      ...
      <div className="menu">
        ...
        <div className="item">
          ...
          <div className="cat">
            <input type="radio" checked={cat === "sceince"} name="cat" value="sceince" id="sceince" onChange={e=>setCat(e.target.value)}/>
          ...
          <div className="cat">
            <input type="radio" checked={cat === "cenima"} name="cat" value="cenima" id="cenima" onChange={e=>setCat(e.target.value)}/>
